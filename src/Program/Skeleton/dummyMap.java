...
/**
 * Olyan osztály, ami a késõbbi pályát fogja szimulálni a skeletonban való tesztelésnél.
 * @author Rover
 *
 */
public class dummyMap {
	/**
	 * Tárol minden páyaelemet
	 * CheckPoints - A játékosok menetirányának ellenörzésére szolgál. 
	 * MapItems - A pályán lévõ akadályok listája.
	 * Robots - A versenyben lévõ robotok listája.
	 * Track - A pálya szélét definiáló vonalakat tartalmazza. 
	 */
	...
	/**
	 * Létrehozásnál létrehozzuk az üres listákat, amik üresek, mert még nincs pálya betölve,
	 * ebbõl kifolyólag nincsenek játékosok se.
	 */
	dummyMap() {
	 ...
	 * @param item - Akadály amit a listára kell felvenni.
	 */
	 ...
	 * @param item - Akadály amit lekell szedni. 
	 */
	 ...
	 * @param robot - Akit vizsgálni kell az akadályokhoz viszonyítva.
	 */
